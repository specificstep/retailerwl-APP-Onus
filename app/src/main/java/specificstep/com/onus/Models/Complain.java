...
public class Complain {
    ...
    public String getTran_service_id() {
        return tran_service_id;
    }

    public void setTran_service_id(String tran_service_id) {
        this.tran_service_id = tran_service_id;
    }
}
